  ...
  return (
    <section id="achievements" className="py-12">
      <div className="flex items-center gap-4 mb-10">
        <h3 className="text-3xl font-black text-slate-900">Certifications & Achievements🏆</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {achievements.map((item, idx) => (
          <a
            ...
            className="group relative p-6 bg-white border border-slate-100 rounded-3xl hover:border-indigo-700/30 hover:shadow-2xl hover:shadow-indigo-50 transition-all duration-300 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-6">
                <div className="p-3 bg-slate-50 rounded-2xl text-indigo-700 group-hover:bg-indigo-700 group-hover:text-white transition-all duration-300">
                  {item.icon}
                </div>
              ...
              <div>
                <h4 className="text-lg font-bold text-slate-900 group-hover:text-indigo-700 transition-colors mb-1">
                  {item.title}
                </h4>
                <p className="text-sm text-slate-500 font-medium mb-4">{item.org}</p>
              </div>

              <div className="flex items-center gap-2 text-xs font-bold text-indigo-700 opacity-0 group-hover:opacity-100 transition-opacity">
