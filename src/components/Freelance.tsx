        ...
        <section id="hire" className="py-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div className="max-w-2xl">
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-white tracking-tighter">
                        Need a Technical <span className="text-indigo-400 italic">Partner?</span>
                    </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {services.map((service, idx) => (
                    <div
                        key={idx}
                        className="group p-8 bg-slate-900/50 border border-slate-800 rounded-[2.5rem] hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/20 hover:bg-slate-900/70 transition-all duration-300 flex flex-col justify-between"
                    >
                        <div>
                            <div className="w-14 h-14 rounded-2xl bg-slate-800/50 flex items-center justify-center text-indigo-400 mb-6 group-hover:bg-indigo-500/10 group-hover:text-indigo-300 transition-all duration-300 group-hover:rotate-6 group-hover:scale-110 border border-slate-700/50">
                                {service.icon}
                            </div>
                        ...
                        <ul className="space-y-2">
                            {service.features.map((feat) => (
                                <li key={feat} className="flex items-center gap-2 text-[10px] font-black uppercase tracking-wider text-slate-500">
            ...
            <div className="relative overflow-hidden bg-slate-950 rounded-[3rem] p-8 md:p-12 border border-slate-800 shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                        <a
                            href="#contact"
                            className="w-full sm:w-auto px-10 py-5 bg-indigo-600 text-white font-black rounded-2xl hover:bg-indigo-500 transition-all shadow-xl shadow-indigo-600/30 flex items-center justify-center gap-3 group"
                        >
                            HIRE FOR PROJECT
                            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                        </a>
                        <div className="flex items-center gap-3 px-6 py-5 bg-slate-900/50 border border-slate-800 rounded-2xl text-white font-bold text-sm">
